/*
 * Original shader from: https://www.shadertoy.com/view/wdGXzK
 */
...
vec3 beamStart=vec3(0.), beamEnd=vec3(0.), beamCol=vec3(0.);
float throughWindow;
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // neon tubes
    float climax = 1.+step(35.,iTime)*5.*step(iTime, 52.);
